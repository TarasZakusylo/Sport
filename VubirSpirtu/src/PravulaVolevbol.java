...
public class PravulaVolevbol extends JFrame {
	...
	public PravulaVolevbol() {
		...
		label_7.setIcon(new ImageIcon("res/fon/PravulaVolevbol.png"));
		label_7.setBounds(0, 0, 789, 484);
		panel_taktika.add(label_7);

		JLabel label_6 = new JLabel("");
		label_6.setIcon(new ImageIcon("res/fon/Pravula.png"));
